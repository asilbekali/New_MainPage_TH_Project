...
import VideoCompareModal from "@/components/modals/VideoCompareModal";
...
const Hero = () => {
  ...
  const renderTitle = () => {
    if (locale === "uz") {
      return (
        <>
          {t("online")} <span style={{ color: "#F48C06" }}>{t("studying")}</span>{" "}
          endi {t("much")}
        </>
      );
    }
    ...
    return (
      <>
        <span style={{ color: "#F48C06" }}>{t("studying")}</span> {t("online")}{" "}
        {t("much")}
      </>
    );
  };
        ...
        <Container maxWidth="lg">
          ...
          >
            ...
            >
              ...
              <Typography
                sx={{
                  color: isDark ? "#A1A1A1" : "#fff",
                  fontSize: { xs: "1rem", md: "1.2rem" },
                  mb: 4.5,
                  maxWidth: { xs: "100%", md: "500px" },
                  mx: { xs: "auto", md: isRtl ? "0 0 0 auto" : 0 },
                }}
              >
                {t("desc")}
              </Typography>
                ...
                <motion.div whileHover={{ scale: 1.04, y: -3 }} whileTap={{ scale: 0.98 }}>
                  <Button
                    ...
                    sx={{
                      ...
                      "&:hover": {
                        bgcolor: "#e07e05",
                        boxShadow: "0 16px 40px rgba(244, 140, 6, 0.35)",
                      },
                    }}
                  >
                    {t("join_free")}
